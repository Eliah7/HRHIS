...
@Entity
@Table(name = "hris_arithmeticfilter", schema = "public", catalog = "hrhis")
public class HrisArithmeticfilterEntity {
    private int id;
    private String uid;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        HrisArithmeticfilterEntity that = (HrisArithmeticfilterEntity) o;
        return id == that.id &&
